    ...
    return(
        <div className={styles.mostPopularSection} id='mostPopularSection'>
            <div className={styles.sectionHeader}>
                <h2>Most Watched Animes</h2>
            </div>
            <div className={styles.slideContainer}>
                <Swiper spaceBetween={5} slidesPerView={slidePerView} pagination={{ clickable: true }} loop className={styles.swiper} autoplay={{delay:2000, disableOnInteraction:false, pauseOnMouseEnter:true}}>
                    {animeList.map((anime) => (
